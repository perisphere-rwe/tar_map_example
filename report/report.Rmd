...
for(analysis_type in c("main", "sens")){
  cat(
    glue(
      "## Table 1: Characteristics for {{analysis_type}} analysis\n",
      "```{r}",
      "characteristics_{{analysis_type}}",
      "```\n\n\n", 
      .open = "{{", 
      .close = "}}",
      .sep = '\n'
...
## Table 1: Characteristics for main analysis

```{r}
characteristics_main
```

## Table 1: Characteristics for sens analysis
